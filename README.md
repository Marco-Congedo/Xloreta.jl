...
> [!TIP] 
> Actual leadfield matrices that can be used in this package are available in [Leadfields.jl](https://github.com/Marco-Congedo/Leadfields.jl).
> The data generated by this package can be visualized using [CortexPlot.jl](https://github.com/Marco-Congedo/CortexPlot.jl).
...
To use this package, all you will need is here below, where it is understood that you replace the example data matrix `X` and the leadfield matrix `K` with your own data and a valid leadfield. To access standard leadfields, see [Leadfields.jl](https://github.com/Marco-Congedo/Leadfields.jl). To visualize the data, see [CortexPlot.jl](https://github.com/Marco-Congedo/CortexPlot.jl).
...
# test the transfer matrix you create
